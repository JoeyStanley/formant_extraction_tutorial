...
In this tutorial, we'll see some of the basics of Praat scripting and we'll focus on just a single TextGrid. We'll get to automatic acoustic measurements later, but for now, we need to understand some fundamental ideas before we get too crazy.
